    ...
    <header class="header-style-3">
            ...
            <div class="mobile-menu ">
              ...
              <div class="mobile-menu__sidebar-menu">
                ...
                <ul class="page-dropdown-menu">
                  <li class="dropdown-list">  <span>Home </span> <span class="menuarrow"> <i
                      class="flaticon-next-1"></i> </span>
                    <ul class="dropdown">
                      <li>  <router-link to="/"> Домашняя страница </router-link>  </li>
                      <li> <a href="index-2.html">Пока пусто </a> </li>
                      <li> <a href="index-3.html">Пока пусто </a> </li>
                      <li> <a href="index-4.html">Пока пусто </a> </li>
                      <li> <a href="index-5.html">Пока пусто </a> </li>
                      <li> <a href="index-6.html">Пока пусто </a> </li>
                      <li> <a href="index-7.html">Пока пусто </a> </li>
                    </ul>
                  </li>
                  <li>  <router-link to="/products"> <span> Продукты </span> </router-link> </li>
                </ul>
                ...
                <div class="row">
                  <nav>
                    <ul
                      ...
                      <li class="dropdown-list"> <router-link to="/">  <span>Home</span> <span
                          class="menuarrow"> <i class="flaticon-down-arrow"></i>
                      </span> </router-link>
                      </li>

                      <li class="dropdown-list"> <router-link to="/products">  <span>Продукты</span> <span
                          class="menuarrow"> <i class="flaticon-down-arrow"></i>
                      </span> </router-link>
                      </li>
                    </ul>
      ...
      <div class="side-cart d-flex flex-column justify-content-between">
        ...
        <div class="bottom">
          ...
          <div class="button-box d-flex justify-content-between">  <router-link to="/cart" class="btn_black"> View Cart  </router-link>
