                      ...
                      <div v-for="product in products" class="col-xl-4 col-lg-6 col-6 ">
                        <div class="products-three-single w-100  mt-30">
                              ...
                              <div class="row justify-content-between align-items-center">
                                ...
                                <div class="col-lg-6">
                                  <div class="popup-right-content">
                                    ...
                                    <div class="price">
                                      <h2> $ {{ popupProduct.price }}<del> {{ popupProduct.old_price? '$'+popupProduct.old_price : ''}} </del></h2>
                                      <h6> In stuck</h6>
                                    </div>
                                    <div class="color-varient">
                                      <template v-for="groupProducts in popupProduct.group_products">
                                      <a @click.prevent="getProduct(groupProducts.id)" v-for="color in groupProducts.colors" href="#0" :style="`background: ${color.title};`" class="color-name"> <span> {{color.title}}</span> </a>
                                      </template>
                                    </div>
                                    <div class="add-product">
                                      ...
                                      <div class="button-group">
                                        ...
                                        <button @click.prevent="addToCard(product)" class="btn--primary "> Добавить в корзину </button>
                                      </div>
                                    </div>
                          ...
                          <div class="products-three-single-content text-center"> <span> {{ product.category.title }}</span>
                            ...
                            <p><del>{{ product.old_price? '$'+product.old_price : ''}}</del>
                             ${{  product.count }}</p>
                          </div>
                        </div>
                      </div>
