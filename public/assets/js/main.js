  ...
  $(document).on('changed', function() {
    ...
    if ($(".ftproductgr").length) {
      $(".ftproductgr").not('.slick-initialized').slick({
        ...
        arrows: true,
        autoplay: true,
        prevArrow: '<button class="arrow-back"> <img src="http://localhost:5173/src/assets/images/home-six/arroe-left.png" alt=""></button>',
        nextArrow: '<button class="arrow-next"> <img src="http://localhost:5173/src/assets/images/home-six/arroe-right.png" alt=""></button>',
        autoplaySpeed: 2000,
        pauseOnHover: false,
        responsive: [{
          breakpoint: 992,
    ...
    if ($(".hero-slider").length) {
      $(".hero-slider").not('.slick-initialized').slick({
        ...
        arrows: true,
        autoplay: true,
        prevArrow: '<button class="arrow-back"><img src="http://localhost:5173/src/assets/images/home-four/arrow-left.png" alt="images"> </button>',
        nextArrow: '<button class="arrow-next"> <img src="http://localhost:5173/src/assets/images/home-four/arrow-right.png" alt="images"></button>',
        autoplaySpeed: 2000,
        pauseOnHover: false,
        responsive: [{
          breakpoint: 576,
